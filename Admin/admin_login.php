...
function clearFunc()
{
 document.getElementById("amail").value="aparul005@gmail.com";
 document.getElementById("pwd1").value="936120";
}
</script>
...
<form action = "admin_valid.php" onsubmit = "return loginn()" method = "POST">
